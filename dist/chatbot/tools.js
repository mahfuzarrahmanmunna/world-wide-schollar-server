...
async ({ title, start, end, attendees, location }) => {
...
async ({ to, message }) => `💬 DM to ${to}: ${message}`, {
    name: "send_slack_dm",
    description: "Send an asynchronous direct message to one Slack recipient. Return a delivery receipt.",
    schema: z.object({
